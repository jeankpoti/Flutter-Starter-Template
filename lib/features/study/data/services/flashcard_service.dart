...
class FlashcardService {
  ...
  Future<FlashCardDeck> generateFlashcardsFromQuiz({
    ...
    for (final question in quiz.questions) {
      ...
      String front = question.questionText;
      String back = '';
      
      // Determine the back content based on question type
    ...
    final deck = FlashCardDeck(
      id: _generateId(),
      userId: userId,
      name: deckName ?? 'Quiz: ${quiz.title}',
      description: deckDescription ?? 'Flashcards generated from quiz: ${quiz.title}',
      createdAt: DateTime.now(),
      cardCount: cards.length,
      newCardCount: cards.length,
      sourceType: 'quiz',
