...
class DeckStatsHeaderWidget extends StatelessWidget {
  ...
  const DeckStatsHeaderWidget({super.key, required this.cards});
            ...
            children: [
              Expanded(
                child: _buildStatChip(
                  context,
                  AppLocalizations.of(context)!.newCards,
                  newCards,
                  Colors.green,
                ),
              ),
              ...
              Expanded(
                child: _buildStatChip(
                  context,
                  AppLocalizations.of(context)!.dueCards,
                  dueCards,
                  Colors.orange,
                ),
              ),
              ...
              Expanded(
                child: _buildStatChip(
                  context,
                  AppLocalizations.of(context)!.learningCards,
                  learningCards,
                  Colors.green,
                ),
              ),
