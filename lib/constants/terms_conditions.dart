...
6. **Prohibited Conduct**
   ...
   - Use the app for any illegal activity or unauthorized purpose.
   - Engage in any behavior that disrupts or interferes with other users' experience.
   - Use the AI for malicious purposes, such as generating inappropriate or harmful content.
...
7. **Subscriptions and Billing**
    ...
    Subscriptions may include a 3-day free trial depending on your platform (App Store or Google Play).
    ...
    You may manage or cancel your subscription through your Apple or Google account settings.

    No refunds are provided for unused portions of a subscription term, unless required by law.

    RevenueCat acts as the system of record for your subscription status.  
...
11. **Modifications**
   ...
   We may update these Terms from time to time. Changes will be effective immediately upon posting the revised Terms in the app. Continued use of the app constitutes acceptance of the modified Terms.
...
6. **Your Choices**
   ...
   - Access, update, or delete your personal information by adjusting your account settings.
...
6. **Conducta Prohibida**
   ...
   - Usar la aplicación para cualquier actividad ilegal o propósito no autorizado.
   - Participar en cualquier comportamiento que interrumpa o interfiera con la experiencia de otros usuarios.
   - Usar la IA con fines maliciosos, como generar contenido inapropiado o dañino.
...
7. **Suscripciones y Facturación**
    ...
    Las suscripciones pueden incluir una prueba gratuita de 3 días según tu plataforma (App Store o Google Play).
    ...
    Puedes administrar o cancelar tu suscripción a través de la configuración de tu cuenta de Apple o Google.

    No se proporcionan reembolsos por partes no utilizadas de un período de suscripción, a menos que lo exija la ley.

    RevenueCat actúa como el sistema de registro para el estado de tu suscripción.
...
11. **Modificaciones**
   ...
   Podemos actualizar estos Términos de vez en cuando. Los cambios serán efectivos inmediatamente después de publicar los Términos revisados en la aplicación. El uso continuado de la aplicación constituye la aceptación de los Términos modificados.
...
6. **Tus Opciones**
   ...
   - Acceder, actualizar o eliminar tu información personal ajustando la configuración de tu cuenta.
