...
class AppReviewService {
  ...
  static const int _minLaunches = 3;
  static const int _minProblemsSolved = 5;
  ...
  static Future<void> checkAndRequestReview({
    ...
    if (lastRequestDate != null) {
      final daysSinceLastRequest = DateTime.now()
          .difference(DateTime.parse(lastRequestDate))
          .inDays;
    ...
    final meetsBasicRequirements = 
        launchCount >= _minLaunches &&
        problemsSolved >= _minProblemsSolved;
    ...
    final shouldRequest = afterPositiveAction &&
        meetsBasicRequirements &&
        meetsQuizRequirement;
  ...
  static Future<void> openStoreListing() async {
    ...
    const iosAppId = '123456789'; // Your iOS app ID
